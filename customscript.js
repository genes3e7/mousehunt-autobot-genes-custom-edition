...
var objBestTrap = {
    weapon: {
        ...
        hydro: ['Chrome School of Sharks', 'School of Sharks', 'Rune Shark', 'Queso Fount', 'Chrome Phantasmic Oasis', 'Phantasmic Oasis', 'Oasis Water Node', 'Haunted Shipwreck', 'Steam Laser Mk. III', 'Steam Laser Mk. II', 'Steam Laser Mk. I', 'Ancient Spear Gun'],
    ...
    if (showTimerInPage) {
        ...
        if (headerElement) {
            ...
            if (targetPage && aggressiveMode)
                titleElement.innerHTML = "<a href=\"https://github.com/genes3e7/mousehunt-autobot-genes-custom-edition\" target=\"_blank\"><b>MouseHunt AutoBot (version " + g_strVersion + " Genes Custom Edition)</b></a> - <font color='red'>Aggressive Mode</font>";
